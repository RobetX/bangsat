...
def passwrd():
	...
	print('')
	print(f'HASIL OK {h}OK{x} Tersimpan Di : {h}OK/%s {x}'%(okc))
	print(f'HASIL CP {k}CP{x} Tersimpan Di : {k}CP/%s {x}'%(cpc))
